...
{
    [SerializeField] private List<GameObject> enemyPrefabs;  // Substituição do array por uma lista
    ...
    {
        int index = Random.Range(0, enemyPrefabs.Count); // Usa Count ao invés de Length para listas
